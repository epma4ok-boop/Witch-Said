...
export default function Home({ lang }: HomeProps) {
  ...
  return (
    <div style={{ background: "#030508", height: `${viewportHeight}px`, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
      ...
      {userTitle && (
        <div style={{ position: "absolute", top: "calc(env(safe-area-inset-top, 0px) + 16px)", left: 16, zIndex: 10 }}>
          <div style={{
      ...
      {/* Category tabs */}
      <div style={{ display: "flex", justifyContent: "center", paddingTop: "calc(env(safe-area-inset-top, 0px) + 14px)", paddingBottom: 4, position: "relative", zIndex: 10, flexShrink: 0 }}>
