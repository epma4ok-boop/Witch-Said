const tg = window.Telegram?.WebApp;
    ...
    const uiCopy = {
      ru: {
        ...
        buttons: { ask: 'Запустить ритуал', share: 'Поделиться ответом' },
      ...
      en: {
        ...
        buttons: { ask: 'Start ritual', share: 'Share the answer' },
    ...
    function applyLangTexts() {
      ...
      document.querySelector('[data-i18n="btnAsk"]').textContent = dict.buttons.ask;
