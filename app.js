const tg = window.Telegram?.WebApp;
    ...
    let casting = false;
    let lastPrediction = 'Ведьма сказала: шар ждёт вопрос, а не кнопку.';
    ...
    const uiCopy = {
      ru: {
        ...
        footerNote: 'Шар шутит, но попадает странно метко.',
        chips: { all: 'Все', love: 'Любовь', work: 'Работа', money: 'Деньги' },
        buttons: { share: 'Поделиться ответом' },
      ...
      en: {
        ...
        footerNote: 'The orb jokes, but hits uncomfortably close.',
        chips: { all: 'All', love: 'Love', work: 'Work', money: 'Money' },
        buttons: { share: 'Share the answer' },
    ...
    function applyLangTexts() {
      ...
      document.querySelector('[data-i18n="sectionHint"]').textContent = dict.sectionHint;
      document.querySelector('[data-i18n="footerNote"]').textContent = dict.footerNote;
      document.querySelector('[data-i18n="chipAll"]').textContent = dict.chips.all;
      document.querySelector('[data-i18n="chipLove"]').textContent = dict.chips.love;
      document.querySelector('[data-i18n="chipWork"]').textContent = dict.chips.work;
      document.querySelector('[data-i18n="chipMoney"]').textContent = dict.chips.money;
      document.querySelector('[data-i18n="btnShare"]').textContent = dict.buttons.share;
    ...
    async function loadPredictions() {
      const candidates = ['./predictions.json', './predictions-4.json', './app/data/predictions.json'];
    ...
    function nextPrediction() {
      ...
      const fallback = 'Шар завис, но внутренне он всё равно прав.';
